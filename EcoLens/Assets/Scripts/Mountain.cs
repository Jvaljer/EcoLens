...
public class Mountain : MonoBehaviour {
    ...
    public void Init(){
        ...
        capsule.transform.rotation = Quaternion.Euler(0,-90,0);
    ...
    private void ActiveObjects(){
        if(obj1!=null){
            ...
            obj1 = dashboard_script.SpawnSetObject("cigaret");
        }
        if(obj2!=null){
            obj2.SetActive(true);
        } else {
            obj2 = dashboard_script.SpawnSetObject("food-wrapper");
        }
        if(obj3!=null){
            obj3.SetActive(true);
        } else {
            obj3 = dashboard_script.SpawnSetObject("drink");
        }
    }
